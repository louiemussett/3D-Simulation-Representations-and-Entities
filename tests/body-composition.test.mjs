...
import { adaptTrainableCondition, BODY_COMPOSITION_PROFILES, improvableConditionNeeds, metabolicRate, migrateBodyComposition, recordTrainingStimulus } from "../src/body-composition.js";
