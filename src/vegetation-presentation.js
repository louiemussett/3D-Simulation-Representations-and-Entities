...
export function vegetationPresentationState(cell = {}, tick = 0) { return { signature: `${cell.terrainClass}|${cell.plantType}|${Boolean(cell.woodland)}|${Boolean(cell.shrubland)}|${cell.woodyStage}|${Boolean(cell.leaflessTreeUntil > tick)}|${Boolean(cell.fallenTreeUntil > tick)}|${band(cell.biomass, .08)}|${band(cell.grassHeight, .1)}`, biomass: Number(cell.biomass) || 0, grassHeight: Number(cell.grassHeight) || 0 }; }
