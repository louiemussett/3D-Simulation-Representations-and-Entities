...
export const SPECIES_LOCOMOTION = Object.freeze({
  ...
  "carrion-runner": gait("ground-stride", "ground-hornbill walking stride", .0048, .05, "peck", false),
  ...
  "cold-country-scavenger": gait("ground-stride", "pheasant walk and short ground run", .0054, .055, "peck", false),
